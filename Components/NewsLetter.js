...
//       <div className="bg-gradient-to-br from-purple-800/80 via-fuchsia-300 to-purple-700 backdrop-blur-2xl p-8 rounded-2xl shadow-lg">
...
//             className="px-4 py-2 rounded-md placeholder:text-white focus:outline-none w-full sm:w-auto"
//             value={email}
